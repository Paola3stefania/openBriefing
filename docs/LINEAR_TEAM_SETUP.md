...
How to configure and use Linear teams with OpenBriefing.
...
- The system will automatically create a team named "OpenBriefing" on first export
- The team will be created with key "OPENBRIEFING"
...
**Option 3: Use OpenBriefing's Team Listing** (if implemented)
