...
--   * empties every embedding-only join table (code_file/code_section/
--     feature/memory),
...
--
-- This migration originally also covered issue/thread/group/documentation/
...
-- 2. Empty embedding-only tables. The source rows (code_files, etc.) keep
-- their data; only the cached vector representations are cleared.
TRUNCATE TABLE
  feature_embeddings,
